...
public class Arquivos {
    ...
    ArrayList<Cadastro> bancodados = new ArrayList<Cadastro>();
    ...
    public void lerArquivo() {
        try {
            ...
            while ((linha = buffRead.readLine()) != null) {
                String vetor[] = linha.split(","); //insere a linha no vetor separando por virgual

                Cadastro objetoCadastrando = new Cadastro(vetor);

                bancodados.add(objetoCadastrando);//arraylist inserindo no 'banco'

            }

            bancodados.sort(null); //ordenando o banco de dados por nome 
    ...
    public static void Write(ArrayList<Cadastro> bancodados) {
        try {
            ...
            for(Cadastro cadastro : bancodados  ){
                bufferWriter.append(cadastro.toString() + "\n");
            }
    ...
    public ArrayList<Cadastro> getBancodados() {
        return bancodados;
    }
